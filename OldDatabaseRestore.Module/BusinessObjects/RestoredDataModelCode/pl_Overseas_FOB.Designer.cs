...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Overseas_FOB : XPLiteObject
    {
        Guid fpl_Overseas_FOB_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Overseas_FOB_ID
        {
            get { return fpl_Overseas_FOB_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Overseas_FOB_ID), ref fpl_Overseas_FOB_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Overseas_FOB")]
