...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Title : XPLiteObject
    {
        Guid fpl_Title_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Title_ID
        {
            get { return fpl_Title_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Title_ID), ref fpl_Title_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Title")]
