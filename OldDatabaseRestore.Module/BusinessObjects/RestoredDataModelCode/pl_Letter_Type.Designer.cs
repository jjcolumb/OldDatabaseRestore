...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Letter_Type : XPLiteObject
    {
        Guid fpl_Letter_Type_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Letter_Type_ID
        {
            get { return fpl_Letter_Type_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Letter_Type_ID), ref fpl_Letter_Type_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Letter_Type")]
