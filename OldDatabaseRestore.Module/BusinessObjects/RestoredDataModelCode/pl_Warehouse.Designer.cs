...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Warehouse : XPLiteObject
    {
        Guid fpl_Warehouse_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Warehouse_ID
        {
            get { return fpl_Warehouse_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Warehouse_ID), ref fpl_Warehouse_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Warehouse")]
