...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Manual_Adjust_Comments : XPLiteObject
    {
        Guid fpl_Manual_Adjust_Comments_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Manual_Adjust_Comments_ID
        {
            get { return fpl_Manual_Adjust_Comments_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Manual_Adjust_Comments_ID), ref fpl_Manual_Adjust_Comments_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Manual_Adjust_Comments")]
