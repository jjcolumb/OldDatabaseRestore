...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Month : XPLiteObject
    {
        Guid fpl_Month_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Month_ID
        {
            get { return fpl_Month_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Month_ID), ref fpl_Month_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Month")]
