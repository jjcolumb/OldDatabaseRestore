...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_PALET : XPLiteObject
    {
        Guid fpl_PALET_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_PALET_ID
        {
            get { return fpl_PALET_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_PALET_ID), ref fpl_PALET_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_PALET")]
