...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Tax_Number_Type : XPLiteObject
    {
        Guid fpl_Tax_Number_Type_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Tax_Number_Type_ID
        {
            get { return fpl_Tax_Number_Type_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Tax_Number_Type_ID), ref fpl_Tax_Number_Type_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Tax_Number_Type")]
