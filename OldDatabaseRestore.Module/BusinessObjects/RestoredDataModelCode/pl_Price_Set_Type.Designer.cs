...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Price_Set_Type : XPLiteObject
    {
        Guid fPrice_Set_Type_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid Price_Set_Type_ID
        {
            get { return fPrice_Set_Type_ID; }
            set { SetPropertyValue<Guid>(nameof(Price_Set_Type_ID), ref fPrice_Set_Type_ID, value); }
        }
        decimal fSort_Order;
        ...
        public XPCollection<PS_Main> PS_Mains { get { return GetCollection<PS_Main>(nameof(PS_Mains)); } }
    }
