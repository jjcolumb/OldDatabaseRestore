...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Address_ShipType : XPLiteObject
    {
        Guid fpl_Address_ShipType_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Address_ShipType_ID
        {
            get { return fpl_Address_ShipType_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Address_ShipType_ID), ref fpl_Address_ShipType_ID, value); }
        }
        decimal fSort_Order;
