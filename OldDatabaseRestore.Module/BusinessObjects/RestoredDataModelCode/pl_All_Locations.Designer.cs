...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_All_Locations : XPLiteObject
    {
        Guid fpl_All_Locations_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_All_Locations_ID
        {
            get { return fpl_All_Locations_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_All_Locations_ID), ref fpl_All_Locations_ID, value); }
        }
