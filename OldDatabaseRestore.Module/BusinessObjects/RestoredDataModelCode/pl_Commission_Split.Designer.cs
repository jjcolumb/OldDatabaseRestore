...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Commission_Split : XPLiteObject
    {
        Guid fpl_Commission_Split_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Commission_Split_ID
        {
            get { return fpl_Commission_Split_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Commission_Split_ID), ref fpl_Commission_Split_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Commission_Split")]
