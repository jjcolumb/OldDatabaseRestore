...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_How_Credit_Disposed : XPLiteObject
    {
        Guid fpl_How_Credit_Disposed_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_How_Credit_Disposed_ID
        {
            get { return fpl_How_Credit_Disposed_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_How_Credit_Disposed_ID), ref fpl_How_Credit_Disposed_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_How_Credit_Disposed")]
