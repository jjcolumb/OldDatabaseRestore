...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Marital_Status : XPLiteObject
    {
        Guid fpl_Marital_Status_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Marital_Status_ID
        {
            get { return fpl_Marital_Status_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Marital_Status_ID), ref fpl_Marital_Status_ID, value); }
        }
        decimal fSort_Order;
