...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Reason_For_Cancel : XPLiteObject
    {
        Guid fpl_Reason_For_Cancel_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Reason_For_Cancel_ID
        {
            get { return fpl_Reason_For_Cancel_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Reason_For_Cancel_ID), ref fpl_Reason_For_Cancel_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Reason_For_Cancel")]
