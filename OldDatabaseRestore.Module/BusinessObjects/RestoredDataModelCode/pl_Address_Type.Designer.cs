...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Address_Type : XPLiteObject
    {
        Guid fpl_Address_Type_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Address_Type_ID
        {
            get { return fpl_Address_Type_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Address_Type_ID), ref fpl_Address_Type_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Address_Type")]
