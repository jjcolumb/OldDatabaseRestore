...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Comment_Where : XPLiteObject
    {
        Guid fpl_Comment_Where_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Comment_Where_ID
        {
            get { return fpl_Comment_Where_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Comment_Where_ID), ref fpl_Comment_Where_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Comment_Where")]
