...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Action_Taken_on_Letter : XPLiteObject
    {
        Guid fpl_Action_Taken_on_Letter_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Action_Taken_on_Letter_ID
        {
            get { return fpl_Action_Taken_on_Letter_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Action_Taken_on_Letter_ID), ref fpl_Action_Taken_on_Letter_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Action_Taken_on_Letter")]
