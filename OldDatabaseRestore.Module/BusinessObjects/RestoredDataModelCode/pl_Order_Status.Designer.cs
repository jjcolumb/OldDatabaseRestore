...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Order_Status : XPLiteObject
    {
        Guid fpl_Order_Status_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Order_Status_ID
        {
            get { return fpl_Order_Status_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Order_Status_ID), ref fpl_Order_Status_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Order_Status")]
        ...
        int fOrder_Status_Int;
        public int Order_Status_Int
        {
            get { return fOrder_Status_Int; }
            set { SetPropertyValue<int>(nameof(Order_Status_Int), ref fOrder_Status_Int, value); }
        }
        string fDescription_Debug;
        [Size(58)]
        public string Description_Debug
        {
            get { return fDescription_Debug; }
            set { SetPropertyValue<string>(nameof(Description_Debug), ref fDescription_Debug, value); }
        }
