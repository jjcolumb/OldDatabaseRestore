...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Shipping_Class : XPLiteObject
    {
        Guid fpl_Shipping_Class_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Shipping_Class_ID
        {
            get { return fpl_Shipping_Class_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Shipping_Class_ID), ref fpl_Shipping_Class_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Shipping_Class")]
