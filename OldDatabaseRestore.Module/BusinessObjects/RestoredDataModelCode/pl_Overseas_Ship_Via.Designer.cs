...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Overseas_Ship_Via : XPLiteObject
    {
        Guid fpl_Overseas_Ship_Via_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Overseas_Ship_Via_ID
        {
            get { return fpl_Overseas_Ship_Via_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Overseas_Ship_Via_ID), ref fpl_Overseas_Ship_Via_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Overseas_Ship_Via")]
