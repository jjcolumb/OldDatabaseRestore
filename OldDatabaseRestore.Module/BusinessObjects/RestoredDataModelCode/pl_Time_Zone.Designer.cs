...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Time_Zone : XPLiteObject
    {
        Guid fpl_Time_Zone_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Time_Zone_ID
        {
            get { return fpl_Time_Zone_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Time_Zone_ID), ref fpl_Time_Zone_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Time_Zone")]
