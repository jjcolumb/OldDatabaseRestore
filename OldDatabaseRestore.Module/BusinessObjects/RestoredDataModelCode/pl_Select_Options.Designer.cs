...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Select_Options : XPLiteObject
    {
        Guid fpl_Select_Options_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Select_Options_ID
        {
            get { return fpl_Select_Options_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Select_Options_ID), ref fpl_Select_Options_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Select_Options")]
