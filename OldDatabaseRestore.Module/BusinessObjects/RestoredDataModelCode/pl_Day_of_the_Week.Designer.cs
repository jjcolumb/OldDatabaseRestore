...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Day_of_the_Week : XPLiteObject
    {
        Guid fpl_Day_of_the_Week_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Day_of_the_Week_ID
        {
            get { return fpl_Day_of_the_Week_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Day_of_the_Week_ID), ref fpl_Day_of_the_Week_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Day_of_the_Week")]
