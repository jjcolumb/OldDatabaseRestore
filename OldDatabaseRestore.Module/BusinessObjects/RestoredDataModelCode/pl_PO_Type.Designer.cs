...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_PO_Type : XPLiteObject
    {
        Guid fpl_PO_Type_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_PO_Type_ID
        {
            get { return fpl_PO_Type_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_PO_Type_ID), ref fpl_PO_Type_ID, value); }
        }
        decimal fSort_Order;
