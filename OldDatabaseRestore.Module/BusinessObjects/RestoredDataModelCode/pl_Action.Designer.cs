...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Action : XPLiteObject
    {
        Guid fpl_Action_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Action_ID
        {
            get { return fpl_Action_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Action_ID), ref fpl_Action_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Action")]
        ...
        int fDirection_Sign;
        public int Direction_Sign
        {
            get { return fDirection_Sign; }
            set { SetPropertyValue<int>(nameof(Direction_Sign), ref fDirection_Sign, value); }
        }
        ...
        public XPCollection<RM_Line_Items> RM_Line_Itemss1 { get { return GetCollection<RM_Line_Items>(nameof(RM_Line_Itemss1)); } }
    }
