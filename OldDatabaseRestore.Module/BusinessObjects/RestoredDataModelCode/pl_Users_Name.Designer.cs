...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Users_Name : XPLiteObject
    {
        Guid fpl_Users_Name_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Users_Name_ID
        {
            get { return fpl_Users_Name_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Users_Name_ID), ref fpl_Users_Name_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_PL_USERS_NAME")]
