...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Formal_Title : XPLiteObject
    {
        Guid fpl_Formal_Title_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Formal_Title_ID
        {
            get { return fpl_Formal_Title_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Formal_Title_ID), ref fpl_Formal_Title_ID, value); }
        }
        decimal fSort_Order;
