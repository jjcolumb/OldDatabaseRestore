...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_State : XPLiteObject
    {
        Guid fpl_State_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_State_ID
        {
            get { return fpl_State_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_State_ID), ref fpl_State_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_State")]
        ...
        [Indexed(Name = @"IX_pl_State_State", Unique = true)]
        [Size(2)]
