...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Vessel_Status : XPLiteObject
    {
        Guid fpl_Vessel_Status_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Vessel_Status_ID
        {
            get { return fpl_Vessel_Status_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Vessel_Status_ID), ref fpl_Vessel_Status_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Vessel_Status")]
