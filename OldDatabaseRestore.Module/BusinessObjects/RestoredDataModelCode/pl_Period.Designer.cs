...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Period : XPLiteObject
    {
        Guid fpl_Period_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Period_ID
        {
            get { return fpl_Period_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Period_ID), ref fpl_Period_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Period")]
