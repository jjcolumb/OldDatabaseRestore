...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Description_of_Item : XPLiteObject
    {
        Guid fpl_Description_of_Item_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Description_of_Item_ID
        {
            get { return fpl_Description_of_Item_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Description_of_Item_ID), ref fpl_Description_of_Item_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Description_of_Item")]
