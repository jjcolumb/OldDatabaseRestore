...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Credit_Reason : XPLiteObject
    {
        Guid fpl_Credit_Reason_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Credit_Reason_ID
        {
            get { return fpl_Credit_Reason_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Credit_Reason_ID), ref fpl_Credit_Reason_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Credit_Reason")]
