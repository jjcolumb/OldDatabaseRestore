...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Inventory_Count_Status : XPLiteObject
    {
        Guid fpl_Inventory_Count_Status_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Inventory_Count_Status_ID
        {
            get { return fpl_Inventory_Count_Status_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Inventory_Count_Status_ID), ref fpl_Inventory_Count_Status_ID, value); }
        }
        decimal fSort_Order;
