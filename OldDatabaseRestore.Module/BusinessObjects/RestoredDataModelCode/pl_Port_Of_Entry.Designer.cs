...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Port_Of_Entry : XPLiteObject
    {
        Guid fpl_Port_Of_Entry_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Port_Of_Entry_ID
        {
            get { return fpl_Port_Of_Entry_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Port_Of_Entry_ID), ref fpl_Port_Of_Entry_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Port_Of_Entry")]
