...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Account_Priority : XPLiteObject
    {
        Guid fpl_Account_Priority_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Account_Priority_ID
        {
            get { return fpl_Account_Priority_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Account_Priority_ID), ref fpl_Account_Priority_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_Account_Priority")]
