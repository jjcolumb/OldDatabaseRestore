...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_ROW : XPLiteObject
    {
        Guid fpl_ROW_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_ROW_ID
        {
            get { return fpl_ROW_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_ROW_ID), ref fpl_ROW_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_pl_ROW")]
