...
namespace OldDatabaseRestore.Module.BusinessObjects.BCI_Database_V2A2013
{
    ...
    public partial class pl_Terms : XPLiteObject
    {
        Guid fpl_Terms_ID;
        [Key(true)]
        [ColumnDbDefaultValue("(newid())")]
        public Guid pl_Terms_ID
        {
            get { return fpl_Terms_ID; }
            set { SetPropertyValue<Guid>(nameof(pl_Terms_ID), ref fpl_Terms_ID, value); }
        }
        decimal fSort_Order;
        [Indexed(@"Description", Name = @"IX_PL_TERMS")]
